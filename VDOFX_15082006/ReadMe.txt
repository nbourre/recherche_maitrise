=================================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet VDOFX
=================================================================================================

AppWizard a créé cette application VDOFX à votre attention. Cette application
...
res\VDOFX.ico
    ...
    est incluse dans le fichier de ressources principal VDOFX.rc.
...
VDOFXDlg.h, VDOFXDlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CVDOFXDlg, qui définit le
    comportement de la boîte de dialogue principale de votre application. Le modèle de boîte de
    dialogue se trouve dans le fichier VDOFX.rc, modifiable dans Microsoft Visual C++.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    ...
    appelé VDOFX.pch, et un fichier de types précompilés StdAfx.obj.
