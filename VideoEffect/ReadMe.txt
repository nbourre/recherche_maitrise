=================================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet VideoEffect
=================================================================================================

AppWizard a créé cette application VideoEffect à votre attention. Cette application
...
res\VideoEffect.ico
    ...
    est incluse dans le fichier de ressources principal VideoEffect.rc.
...
VideoEffectDlg.h, VideoEffectDlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CVideoEffectDlg, qui définit le
    comportement de la boîte de dialogue principale de votre application. Le modèle de boîte de
    dialogue se trouve dans le fichier VideoEffect.rc, modifiable dans Microsoft Visual C++.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    ...
    appelé VideoEffect.pch, et un fichier de types précompilés StdAfx.obj.
