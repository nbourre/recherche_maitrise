=================================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet EyeTracker
=================================================================================================

AppWizard a créé cette application EyeTracker à votre attention. Cette application
...
res\EyeTracker.ico
    ...
    est incluse dans le fichier de ressources principal EyeTracker.rc.
...
EyeTrackerDlg.h, EyeTrackerDlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CEyeTrackerDlg, qui définit le
    comportement de la boîte de dialogue principale de votre application. Le modèle de boîte de
    dialogue se trouve dans le fichier EyeTracker.rc, modifiable dans Microsoft Visual C++.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    ...
    appelé EyeTracker.pch, et un fichier de types précompilés StdAfx.obj.
